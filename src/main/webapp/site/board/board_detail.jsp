...
<%-- => [글변경]을 클릭한 경우 게시글 변경 입력페이지(board_modify_action.jsp)로 이동 - 글번호 전달 --%>
<%-- => [답글쓰기]를 클릭한 경우 게시글 입력페이지(board_write_action.jsp)로 이동 - 답글 관련 정보 전달 --%>
...
<div id="board_detail">
	...
	<div id="board_menu">
		<%-- 로그인 사용자가 작성자이거나 관리자인 경우에만 삭제와 변경 가능 --%>
